...
{
    internal class UtilitiesDateTimeHelperTests
    {
        [TestCase("12/02/2008", "20081202")]
        [TestCase("2/28/2000", "20000228")]
        public void Utilities_DateTimeHelper_ToEncoreDate_ReturnsCorrectly(string dateStr, string expected)
        {
        ...
        public void Utilities_DateTimeHelper_ToEncoreTime_ReturnsCorrectly(string dateStr, string expected)
        {
            var date = TestHelper.ConvertTestArgumentToDateTime(dateStr);
